...
<body>
	...
	<section class="body-main">
		...
		<h2 style="color:#00cc88">Item Added To Cart Successfully</h2></c:if>
		<table style="width:100%;" id="menuitems">
			...
			<tr>
				...
				<td class="td-text-align-right"><fmt:setLocale value="en_IN"/><fmt:formatNumber type="currency" value="${item.price}"/></td>
				<td>${item.category}</td>
