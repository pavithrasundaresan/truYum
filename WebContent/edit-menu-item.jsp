...
<body>
<c:set var="category" value="MainCourse,Starters,Desserts,Drinks" scope="application"/>
				...
				<form name="editMenuForm" action="EditMenuItemServlet" method="post"
					...
					<table style="width: 100%">
						...
						<tr>
							...
							<td><input type="date" name="date" id="launchDate" value=<fmt:formatDate pattern="dd/MM/yyyy" value="${menuItem.dateOfLaunch}"/> ></td>
						...
						<tr>
							<td style="padding-top:25px"><input type="checkbox" name="freedelivery"
								value="${menuItem.freeDelivery}"
								<c:if test="${menuItem.freeDelivery}">checked="checked"</c:if> />
								<label>Free Delivery</label></td>
						</tr>
						
						<tr>
							<td style="padding-top:25px"><a href="edit-menu-item-status.jsp"><input
